	...
	public override void Update()
	{
			...
			stateMachine.State != States.StrawbReveal && stateMachine.State != States.Cassette)
		{
			// Rotate Camera
			{
				...
				rot -= Controls.Camera.Value.X * Time.Delta * 4 * (Save.Instance.InvertXCamera ? -1 : 1);
			...
			{
				cameraTargetDistance += Controls.Camera.Value.Y * Time.Delta * (Save.Instance.InvertYCamera ? -1 : 1);
